...
(() => {
    ...
    const DEEP_STORAGE_KEY = 'vgen-deep-guide-seen';
    let deepGuide = null;
    let observer = null;
    let checkTimer = null;
    ...
    const showDeepGuide = () => {
        ...
        deepGuide.innerHTML = `
            ...
            <div class="deep-guide-kicker"><i class="fas fa-dna"></i> TWO LEVELS OF DETAIL</div>
            <h2>Unlock Deep Molecular & Diagnostic View</h2>
            <p>Tap <strong>Deep View</strong> for detailed karyotyping techniques, molecular pedigree charts, statistical genetics derivations, and quantitative breeding formulas.</p>
...
(() => {
    ...
    const TOPIC_STORAGE_KEY = 'vgen-topic-guide-seen';
    let topicGuide = null;
    let checkTimer = null;
