/* ============================================================
   ...
   Next-Gen EdTech Learning Dashboard:
     - 0–1000 XP Animal Genetics Mastery Index with Circular Gauge & Ranks
...
var dashboardApp = (function () {
        ...
        '<div class="dash-hero">' +
          '<div class="dash-cockpit">' +
            ...
            '<div class="dash-cockpit-info">' +
              ...
              '<p class="dash-lede">' +
                'Real-time exam readiness index, spaced retention health, and syllabus coverage across all three VCI Theory Units and three Practical Units.' +
              '</p>' +
  ...
  function getRank(xp) {
    if (xp >= 750) {
      return { title: "Master Animal Geneticist", stage: "Phase 4 · Elite Population Genomics & Sire Selection", icon: "trophy" };
    }
    if (xp >= 500) {
      return { title: "Senior Animal Breeder", stage: "Phase 3 · Board Exam Ready", icon: "sparkle" };
    }
    if (xp >= 250) {
      return { title: "Junior Biostatistician", stage: "Phase 2 · Experimental Design & Genetic Metrics", icon: "search" };
    }
      ...
      lessonCard =
        '<div class="presc-card">' +
          '<div>' +
            ...
            '<h3 class="presc-title mt-2">All 104 Topics Read</h3>' +
  ...
  function renderPaperReadiness(syl, readMap, quiz) {
    ...
    var p1 = computePaper(["unit-1", "unit-2", "prac-unit-1", "prac-unit-2"], "Paper I", "Biostatistics & Animal/Population Genetics");
    var p2 = computePaper(["unit-3", "prac-unit-3"], "Paper II", "Principles of Animal Breeding");
      ...
      return '<div class="paper-gauge-card">' +
        '<div class="paper-card-head">' +
          '<div>' +
            ...
            '<p class="paper-card-subtitle">Units ' + (p.label === "Paper I" ? "1, 2" : "3") + ' (Theory + Practical)</p>' +
          '</div>' +
        '</div>' +
  ...
  function renderUnitMatrix(filter, allUnits, readMap, quiz) {
    ...
    return '<div class="unit-mastery-grid">' +
      filtered.map(function (u) {
        ...
        var paperTag = (u.no <= 2) ? "Paper I" : "Paper II";
  ...
  function findLowestScoringUnit(allUnits, quiz) {
    ...
    return candidate || { id: "unit-1", name: "Biostatistics and Computer Applications", score: 0, hasScore: false };
  }
