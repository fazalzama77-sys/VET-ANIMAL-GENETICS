...
var app = (function () {
  ...
  function _renderGlossaryInner(term, def) {
    ...
    return '<div class="home-glossary-card-inner">' +
      ...
      '<div class="row mt-4">' +
        '<a class="btn btn--sm btn--soft" href="#/library">' + icon("book") + ' Browse 480-Term Glossary →</a>' +
  ...
  function renderLibrary() {
    ...
    view.innerHTML =
      ...
      '</div>' +
      '<div class="tabs">' +
        [['bookmarks', 'Bookmarks', 'star'], ['notes', 'Notes', 'note'], ['highlights', 'Highlights', 'pen'], ['glossary', 'Glossary (480)', 'book']].map(function (item) {
