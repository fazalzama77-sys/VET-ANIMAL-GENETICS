...
var app = (function () {
  ...
  var ICONS = {
    ...
    scale:     '<path d="m16 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="m2 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="M7 21h10M12 3v18M3 7h18"/>',
  ...
  function _initLandingCanvas() {
    ...
    function renderLoop() {
      ...
      if (width > 600) {
        ...
        ctx.fillText("ANIMAL_GENETICS_STUDIO // UNITS_1_3_ONLINE", width - 240, txtY + 13);
      }
  ...
  /* ============================================================
     SPOTTERS OF THE DAY (High-Yield Cytogenetic & Genetic Disorders)
     ============================================================ */
  var SPOTTERS_OF_THE_DAY = [
    {
      name: "Bovine Leukocyte Adhesion Deficiency (BLAD)",
      organ: "Hematopoietic System & Mucosae (Holstein Cattle)",
      etiology: "Autosomal recessive point mutation (A383G transition) in the CD18 (ITGB2) gene encoding the beta-2 integrin subunit.",
      gross: "Recurrent bacterial infections, severe necrotizing gingivitis, periodontitis, intractable bronchopneumonia, chronic diarrhea, and stunted growth in young calves.",
      micro: "Extreme, persistent neutrophilia / granulocytosis (>50,000–100,000/μL) with a total absence of extravascular neutrophils at sites of infection due to defective diapedesis.",
      viva: "Diagnostic test: PCR-RFLP using TaqI or HaeIII restriction enzyme on blood DNA. Bulls used for AI must be genotyped (BLAD-carrier status: TL = tested free, BL = carrier). All carriers eliminated from breeding herds.",
      unitId: "unit-2",
      topicId: "u2-t05",
      badge: "Autosomal Recessive Lethal"
    },
    {
      name: "Citrullinemia in Holstein-Friesian Cattle",
      organ: "Central Nervous System & Liver (Holstein)",
      etiology: "Autosomal recessive nonsense mutation (C to T transition in codon 86) in the argininosuccinate synthetase (ASS1) gene.",
      gross: "Calves normal at birth; by day 2-4 develop depression, anorexia, aimless wandering, head pressing, episodic blindness, tetanic spasms, and death within one week.",
      micro: "Massive hyperammonemia (10-20x normal) and extreme citrulline accumulation in plasma and CSF. Spongiform encephalopathy with Alzheimer type II astrocytosis in cerebrum.",
      viva: "Enzyme defect blocks conversion of citrulline to argininosuccinate in urea cycle. Identified globally via genomic screening following discovery in Australian Holstein sire Linmack Kriss King. Molecular diagnosis: PCR-RFLP (AvaII).",
      unitId: "unit-2",
      topicId: "u2-t05",
      badge: "Inborn Error of Metabolism"
    },
    {
      name: "Freemartinism in Bovine Heterosexual Twins",
      organ: "Reproductive Tract & Chimerism (Bovine Heifer)",
      etiology: "Chorionic vascular anastomosis in heterosexual twin pregnancy (XX heifer + XY bull calf); transfer of anti-M\u00FCllerian hormone (AMH) and testosterone from male co-twin.",
      gross: "Heifer born sterile: severely shortened blind-ended vagina, enlarged clitoris with prominent hair tuft, absent cervix and uterine horns, and hypoplastic or testoid gonads.",
      micro: "Erythrocyte and lymphocyte chimerism (60,XX / 60,XY karyotype). Hypoplastic M\u00FCllerian ducts and rudimentary Wolffian duct derivatives (seminal vesicles, epididymis).",
      viva: "Occurs in >90-95% of bovine heterosexual twin gestations. Clinical test: probe test (vaginal length < 8-10 cm vs normal 13-15 cm). Definitive diagnosis: PCR for SRY/Y-specific sequences or chromosomal karyotype demonstrating XX/XY chimerism.",
      unitId: "unit-2",
      topicId: "u2-t09",
      badge: "Vascular Anastomosis & Chimerism"
    },
    {
      name: "Robertsonian Translocation rob(1;29) in Cattle",
      organ: "Germ Cells & Chromosomal Complement (Bovine)",
      etiology: "Centric fusion (Robertsonian translocation) between acrocentric chromosomes 1 and 29 producing a large submetacentric chromosome.",
      gross: "Carrier animals are phenotypically completely normal, healthy, and vigorous, but show significant reduction in reproductive performance and elevated early embryonic mortality.",
      micro: "Karyotype 2n = 59,XX or 59,XY (heterozygous carrier) or 2n = 58 (homozygous). Meiotic non-disjunction produces aneuploid gametes (nullisomic or disomic for chr 1 or 29).",
      viva: "Discovered by Gustavsson (1964) in Swedish Red and White cattle. Carriers show a 5-10% drop in conception rate due to early embryonic death. Mandatory Giemsa-banding (G-banding) cytogenetic screening for all AI breeding bulls; carriers are culled.",
      unitId: "unit-2",
      topicId: "u2-t13",
      badge: "Structural Chromosomal Aberration"
    },
    {
      name: "Complex Vertebral Malformation (CVM)",
      organ: "Axial Skeleton & Cervical Vertebrae (Holstein)",
      etiology: "Autosomal recessive point mutation (G to T transversion) in the SLC35A3 gene encoding UDP-N-acetylglucosamine transporter.",
      gross: "Aborted fetuses or stillborn calves with severe shortening of cervical spine, hemivertebrae, scoliosis/kyphosis, ankylosed joints, and bilateral symmetric arthrogryposis of fetlocks.",
      micro: "Impaired glycosylation of skeletal proteoglycans during early chondrogenesis, disrupting vertebral segmentation and epiphyseal endochondral ossification.",
      viva: "Traced back to former top international Holstein sire Carlin-M Ivanhoe Bell. Pedigree tracing and PCR-PIRA or TaqMan allelic discrimination assays mandatory for herd book registration (code CV = carrier, TV = tested free).",
      unitId: "unit-2",
      topicId: "u2-t05",
      badge: "Lethal Skeletal Dysplasia"
    },
    {
      name: "Porcine Stress Syndrome (PSS / Malignant Hyperthermia)",
      organ: "Skeletal Muscle & Sarcoplasmic Reticulum (Porcine)",
      etiology: "Autosomal recessive point mutation (C1843T transition: Arg615Cys) in the skeletal muscle ryanodine receptor gene (RYR1).",
      gross: "Under acute stress, transport, or halothane anesthesia: extreme muscle rigidity, rapid body temperature spike (>42\u00B0C), tachypnea, cyanosis, and death within minutes; yields Pale, Soft, Exudative (PSE) pork.",
      micro: "Defective calcium channel gating in sarcoplasmic reticulum; uncontrolled efflux of Ca2+ into myoplasm triggers hypermetabolism, glycogenolysis, and lactic acidosis.",
      viva: "Halothane challenge test historically used (extension of hind limbs on 3% halothane inhalation). Replaced by definitive PCR-RFLP test on blood/tissue DNA. Sires must be tested free (NN) to eliminate PSE meat loss.",
      unitId: "unit-2",
      topicId: "u2-t18",
      badge: "Pharmacogenetic Point Mutation"
    }
  ];
  ...
  function _renderGlossaryInner(term, def) {
    var cat = "Feed Analysis & Proximate Principles";
    ...
    return '<div class="home-glossary-card-inner">' +
      ...
      '<div class="row mt-4">' +
        '<a class="btn btn--sm btn--soft" href="#/library">' + icon("book") + ' Browse 540-Term Glossary →</a>' +
  ...
  function renderHome() {
    ...
    // Exam and Practical breakdown (Paper I: Units 1 & 2; Paper II: Units 3 & 4)
    var p1Units = ["unit-1", "unit-2"];
    var p1Topics = 0, p1Read = 0;
    syllabus.theory.filter(function (u) { return p1Units.indexOf(u.id) !== -1; }).forEach(function (u) {
    ...
    var p2Units = ["unit-3", "unit-4"];
    var p2Topics = 0, p2Read = 0;
    syllabus.theory.filter(function (u) { return p2Units.indexOf(u.id) !== -1; }).forEach(function (u) {
    ...
    var rankTitle = "Genetics Apprentice";
    if (masteryXp >= 750) rankTitle = "Master Animal Geneticist";
    else if (masteryXp >= 500) rankTitle = "Senior Animal Breeder";
    else if (masteryXp >= 250) rankTitle = "Junior Population Analyst";
    ...
    var termKeys = Object.keys((window.glossary && glossary.terms) || {});
    var dailyTermKey = termKeys.length ? termKeys[dayOfYear % termKeys.length] : "heritability";
    var dailyTermDef = (window.glossary && glossary.terms[dailyTermKey]) || "The proportion of total phenotypic variance among individuals in a population that is attributable to genetic differences (specifically additive genetic variance in narrow sense).";

    // Prioritize resume card message
    var resumeIcon = "theory";
    var resumeTitle = "Ready to start studying?";
    var resumeSubtitle = "Begin with Unit 1: Biostatistics and Computer Applications.";
    ...
    if (q.incorrect && q.incorrect.length > 0) {
      ...
      resumeSubtitle = "Reinforce weak spots and master tricky animal genetics questions.";
    ...
    view.innerHTML =
      ...
      '<div class="home-scholar-bar">' +
        '<div class="home-scholar-greeting">' +
          ...
          '<p class="home-greeting-sub">Animal Genetics &amp; Breeding Studio · B.V.Sc &amp; A.H. Year 2 · VCI MSVE 2016</p>' +
        '</div>' +
      ...
      '<section class="hero">' +
        ...
        '<div class="hero__inner">' +
          ...
          '<h1 class="hero__title">Animal Genetics<br><span class="hero__title-accent">Studio</span></h1>' +
          '<p class="lede hero__lede">Three theory units, three practical units, a question bank and an interactive quiz engine — ' +
          'built for B.V.Sc &amp; A.H. second-year students under VCI MSVE 2016. Works offline once loaded.</p>' +
          '<div class="hero__cta">' +
            (lastT
      ...
      '<div class="home-actions-grid">' +
        '<a class="home-action-tile" href="#/quiz/grand">' +
          ...
          '<p class="action-tile-desc">Instant randomized 10-question genetics &amp; breeding sprint with real-time scoring.</p>' +
        ...
        '<a class="home-action-tile" href="#/practical">' +
          ...
          '</div>' +
          '<h3 class="action-tile-title">Genetics Lab &amp; Breeding Hub</h3>' +
          '<p class="action-tile-desc">Karyotyping, pedigree analysis, breeding value estimation &amp; biometrics.</p>' +
        ...
        '<a class="home-action-tile" href="#/qa">' +
          ...
          '<p class="action-tile-desc">Solved VCI Board past questions with gold-standard model answers.</p>' +
          '<span class="action-tile-arrow">Study Q&amp;A →</span>' +
        '</a>' +
      '</div>' +

      /* 4. Animal Genetics Spotter of the Day (Genetic Disorder Spotlight) */
      '<div class="home-spotter-card">' +
        '<div class="spotter-header">' +
          '<div>' +
            '<span class="spotter-eyebrow">' + icon("sparkle") + ' ANIMAL GENETICS SPOTTER OF THE DAY · ' + esc(spotter.badge) + '</span>' +
        ...
        '<div class="spotter-gross-box">' +
          '<h4>' + icon("eye") + ' Cardinal Phenotypic &amp; Diagnostic Hallmark</h4>' +
        ...
        '<div id="spotter-details-drawer" class="spotter-details-drawer">' +
          '<div class="spotter-details-grid">' +
            '<div class="spotter-detail-item">' +
              '<h5>' + icon("pulse") + ' Primary Mode of Inheritance &amp; Molecular Etiology</h5>' +
              '<p>' + esc(spotter.etiology) + '</p>' +
            '</div>' +
            '<div class="spotter-detail-item">' +
              '<h5>' + icon("microscope") + ' Cytogenetic &amp; Molecular Hallmark</h5>' +
              '<p>' + esc(spotter.micro) + '</p>' +
            '</div>' +
            '<div class="spotter-detail-item" style="grid-column: 1 / -1;">' +
              '<h5>' + icon("target") + ' Practical Exam Viva Distinction &amp; Breeding Intervention</h5>' +
      ...
      '<h2 class="mt-10">Explore Animal Genetics Domains</h2>' +
      '<p class="muted mt-1">Structured comprehensive curriculum following VCI MSVE 2016 guidelines.</p>' +
      '<div class="home-domains-grid">' +
        homeDomainCard("theory", "Theory Curriculum", "Three units · 79 topics", "Biostatistics & computer applications, population genetics, and principles of animal breeding.", readPct, readCount + " / " + allTopics + " read", "#/theory", "ico--blue") +
        homeDomainCard("practical", "Practical Lab & Calculations", "Three units · 25 practicals", "Karyotyping, pedigree analysis, Chi-square tests, heritability calculations, and breeding records.", null, "3 Practical Units", "#/practical", "ico--teal") +
        ...
        homeDomainCard("why", "WHY Mechanisms", totalWhy + " comparative explanations", "Comparative inheritance, inbreeding depression, selection response, and heterosis.", null, totalWhy + " Mechanisms", "#/why", "ico--purple") +
        homeDomainCard("dashboard", "Clinical Dashboard", "Analytics & SRS pipeline", "Genetics mastery gauge, 84-day heatmap, weak spots and Leitner memory queue.", Math.round(masteryXp / 10), masteryXp + " / 1000 XP", "#/dashboard", "ico--blue") +
      '</div>' +

      /* 6. VCI Board Annual Examination Structure */
      '<h2 class="mt-12">VCI Board Examination Structure</h2>' +
      '<p class="muted mt-2">The Veterinary Council of India annual examination encompasses two comprehensive theory papers (100 Marks each) and practical board examination (60 Marks).</p>' +
      '<div class="home-exam-grid">' +
        homePaperCard("Paper I", "Biostatistics &amp; Animal Genetics", [1, 2], p1Read, p1Topics, p1Pct, "paper-1", "paper-badge--p1", "fill--blue") +
        homePaperCard("Paper II", "Principles of Animal Breeding", [3], p2Read, p2Topics, p2Pct, "paper-2", "paper-badge--p2", "fill--amber") +
        homePaperCard("Practical Exam", "Biometrics, Cytogenetics &amp; Breeding", [1, 2, 3], pracRead, pracTopics, pracPct, "practical", "paper-badge--p2", "fill--teal") +
      '</div>' +
      ...
      '<div class="footer-credits-wrap">' +
        ...
        '<div class="footer-nav">' +
          '<div class="footer-nav__head">Browse Animal Genetics</div>' +
  ...
  function homePaperCard(paperName, subtitle, unitNums, readDone, readTotal, pctVal, paperId, badgeClass, fillClass) {
    ...
    return '<div class="home-paper-card">' +
      ...
      '<div class="paper-progress-wrap">' +
        ...
        '</div>' +
        '<div class="row">' +
          '<a class="btn btn--soft btn--sm" href="' + (paperId === "practical" ? "#/practical" : "#/quiz/paper/" + paperId) + ' ">' +
  ...
  function renderStream(stream) {
    ...
    var cards = units.map(function (u) {
      ...
      return '<a class="card card--link unitcard" href="#/unit/' + u.id + '">' +
        '<div class="row row--wrap">' +
          ...
          '<span class="chip push">' + (isTheory ? (u.no <= 2 ? "Paper I" : "Paper II") : "Practical Exam") + '</span>' +
        '</div>' +
    ...
    view.innerHTML =
      '<div class="pagehead">' +
        '<span class="eyebrow">' + (isTheory ? "3 credit hours (Theory)" : "1 credit hour (Practical)") + '</span>' +
        '<h1>' + (isTheory ? icon("theory") + ' Theory Curriculum' : icon("practical") + ' Practical Curriculum') + '</h1>' +
        '<p class="lede">' + (isTheory
          ? "The three theory units of the VCI Animal Genetics and Breeding syllabus (Units 1–3, Papers I & II)."
          : "The three practical units: biostatistics & computing, genetics & cytogenetics, and breeding plans.") + '</p>' +
    ...
    if (hasContent(t.id)) {
      ...
      body =
        ...
        (c.img
          ...
          : '<div class="genetics-image-placeholder"><div class="genetics-placeholder-body">' +
              icon("search") +
              '<div class="genetics-placeholder-title">High-Quality Animal Genetics &amp; Breeding Visuals in Development</div>' +
              '<div class="genetics-placeholder-sub">Carefully curated karyotypes, pedigree charts, chromosomal maps, breeding schemas, and statistical curves are in compilation.</div>' +
            '</div></div>') +
  ...
  var onboardSlides = [
    {
      ...
      title: "Animal Genetics Studio",
      body: "Built specifically for 2nd-year B.V.Sc &amp; A.H. students under VCI MSVE 2016. Covers all 3 VCI Theory Units, 3 Practical Units, biostatistics numericals, population genetics, and animal breeding strategies.",
      icon: "dna"
    },
    {
      kicker: "DUAL STUDY DEPTHS",
      title: "Standard vs Deep View",
      body: "Every lesson features <b>Standard View</b> for high-yield exam revision and <b>Deep View</b> for comprehensive quantitative genetics derivations, molecular mechanisms, and selection formulas. Switch anytime at the top of each lesson.",
      icon: "sparkle"
    },
    {
    ...
    },
    {
      ...
      body: "Install this app on your phone, tablet, or laptop. It works completely offline in genetics labs, breeding farms, classrooms, and hostels with zero internet required.",
      icon: "download"
    }
  ];
  ...
  function renderWhy() {
    ...
    var head =
      '<div class="pagehead">' +
        ...
        '<h1>' + icon("why") + ' WHY</h1>' +
        '<p class="lede">Animal Genetics &amp; Breeding is only memorisable once it stops being an arbitrary list. ' +
        'Each card here explains the cytogenetic, population genetic, molecular, or quantitative breeding mechanism behind phenotypic hallmarks and breeding strategies.</p>' +
      '</div>';
    ...
    var toolbarHtml =
      '<div class="why-toolbar">' +
        '<div class="why-search-box">' +
          '<span class="why-search-icon">' + icon("search") + '</span>' +
          '<input type="text" id="whySearchInput" class="why-search-input" placeholder="Search structure, species, gene, mechanism..." autocomplete="off">' +
        '</div>' +
        '<div class="why-filter-pills" id="whyFilterPills">' +
          filterCategories.map(function (c, idx) {
            return '<button class="why-pill' + (idx === 0 ? ' is-active' : '') + '" data-filter="' + c.id + '">' + esc(c.label) + '</button>';
          }).join("") +
        '</div>' +
        '<button class="why-challenge-btn" id="whyChallengeBtn">' +
          icon("brain") + ' Challenge Me' +
        '</button>' +
      '</div>';
    ...
    function getFilteredData() {
      return rawData.filter(function (item) {
        var matchesFilter = (currentFilter === "all") ||
          ...
          (item.unit === currentFilter);

        var query = currentSearch.trim().toLowerCase();
        var matchesSearch = !query ||
          (item.title && item.title.toLowerCase().indexOf(query) !== -1) ||
          (item.comparison && item.comparison.toLowerCase().indexOf(query) !== -1) ||
          (item.why && item.why.toLowerCase().indexOf(query) !== -1);
    ...
    function paint() {
      ...
      if (!filtered.length) {
        grid.innerHTML = '<div class="empty" style="grid-column: 1/-1;"><p>No WHY entries match your search or filter.</p></div>';
        return;
      }

      grid.innerHTML = filtered.map(function (w) {
        var catClass = "category-" + (w.category || "mechanism");
        return '<article class="whycard-compact ' + catClass + '" data-why-id="' + w.id + '">' +
          '<div>' +
            '<div class="whycard-header">' +
              '<span class="card-category">' + esc(w.category || "mechanism") + '</span>' +
              '<span class="card-arrow">&rarr;</span>' +
            '</div>' +
            '<h3 class="whycard-title">' + esc(w.title) + '</h3>' +
            '<div class="whycard-comparison">' +
              '<span class="comp-icon">' + icon("scale") + '</span> ' + esc(w.comparison || "") +
            '</div>' +
    ...
    els("#whyFilterPills .why-pill").forEach(function (btn) {
      btn.addEventListener("click", function () {
        els("#whyFilterPills .why-pill").forEach(function (b) { b.classList.remove("is-active"); });
    ...
    // Direct link to specific card via URL parameter (e.g. #/why?a=1)
    if (state.params.a) {
  ...
  function exportHighlights() {
    ...
    var lines = [
      "# Animal Genetics & Breeding Study Highlights",
  ...
  function exportNotes() {
    ...
    var lines = [
      "# Animal Genetics & Breeding Personal Notes",
      "ICAR-Indian Veterinary Research Institute · Izatnagar",
      "Exported on: " + new Date().toLocaleDateString() + "\n"
    ];
    keys.forEach(function (id) {
  ...
  function renderLibrary() {
    ...
    view.innerHTML =
      ...
      '</div>' +
      '<div class="tabs">' +
        [['bookmarks', 'Bookmarks', 'star'], ['notes', 'Notes', 'note'], ['highlights', 'Highlights', 'pen'], ['glossary', 'Glossary (540)', 'book']].map(function (item) {
      ...
      var toolbarHtml =
        '<div class="lib-topbar">' +
          '<div class="hl-toolbar">' +
            '<div class="hl-search-wrap">' +
              icon("search", "hl-search-icon") +
              '<input type="search" class="hl-search-input" id="gloss-search" placeholder="Search ' + allTerms.length + ' animal genetics &amp; breeding definitions and terms…" value="' + esc(state._glossSearch || "") + '">' +
            '</div>' +
            '<div class="hl-filter-chips">' +
  ...
  function renderMe() {
    ...
    view.innerHTML =
      ...
      '<div class="card mb-4">' +
        ...
        '<p class="muted mt-2">Get an alert when flashcards and high-yield animal genetics questions are due for active recall.</p>' +
  ...
  function _maybeShowSrsNotification() {
    ...
    var lastNotified = localStorage.getItem("vgen-notify-last");
    if (lastNotified === todayStr) return;

    var due = store.dueSrs().length;
    var msg = due > 0
      ? "You have " + due + " question" + (due === 1 ? "" : "s") + " due for review today in Spaced Repetition."
      : "Time for your daily Animal Genetics recall review!";

    var opts = {
      body: msg,
      icon: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><rect width='32' height='32' rx='7' fill='%231565c0'/><text x='16' y='22' font-size='16' font-family='monospace' font-weight='bold' fill='white' text-anchor='middle'>AG</text></svg>",
      badge: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><rect width='32' height='32' rx='7' fill='%231565c0'/><text x='16' y='22' font-size='16' font-family='monospace' font-weight='bold' fill='white' text-anchor='middle'>AG</text></svg>",
      tag: "vgen-srs-daily",
      renotify: true
    };
    ...
    if (navigator.serviceWorker && navigator.serviceWorker.ready) {
      navigator.serviceWorker.ready.then(function (reg) {
        if (reg.showNotification) reg.showNotification("Animal Genetics Studio", opts);
        else new Notification("Animal Genetics Studio", opts);
      }).catch(function () {
        try { new Notification("Animal Genetics Studio", opts); } catch (e) {}
      });
    } else {
      try { new Notification("Animal Genetics Studio", opts); } catch (e) {}
    }
    localStorage.setItem("vgen-notify-last", todayStr);
  }
  ...
  function setSrsNotificationTime(val) {
    ...
    localStorage.removeItem("vgen-notify-last");
    _maybeShowSrsNotification();
    _scheduleNextSrsNotification();
